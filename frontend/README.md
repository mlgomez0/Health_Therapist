...
docker tag capstone-project-front:1.0.0 dockerioip.azurecr.io/capstone-project-front:1.0.0
```

``` bash
az acr login --name dockerioip
docker push dockerioip.azurecr.io/capstone-project-front:1.0.0
```
